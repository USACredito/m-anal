...
from scripts.agentes_config import clasificar_llamada_aircall
load_dotenv()
...
def sync_calls():
    ...
    try:
        ...
        for call in calls_with_recording:
            ...
            # Clasificar setter/closer por user ID exacto de Aircall
            tipo_llamada = clasificar_llamada_aircall(user_id)
